        ...
        <el-card class=" w-full h-fit">
            <template #header>
                <el-input v-model="inputVal" placeholder="请输入内容" size="large" class="w-1/2">
                    ...
                    <template #append>
                        <el-button type="primary"  id="search" @click="searchProvider">
            ...
            <el-table :data="tableData" style="width: 100%; height: fit-content;" size="large" ref="tableRef"
                        row-key="date"
                ...
                <el-table-column fixed="right" label="选择"  align="center">
                    <template #default>
                        <el-button  type="primary" size="large"  @click="handleClick">选择</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination background layout="prev, pager, next" :total="total" class="center-x w-fit mt-2" @current-change="handlePageChange"/>
        </el-card>
    </el-container>
</template>
